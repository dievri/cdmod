...
dofile(minetest.get_modpath("cdmod") .. mode .. "_dirs/platform_node.lua")
...
dofile(minetest.get_modpath("cdmod") .. mode .. "_dirs/create_circle.lua")
dofile(minetest.get_modpath("cdmod") .. mode .. "_dirs/read_directory.lua")