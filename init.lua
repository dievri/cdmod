...
dofile(minetest.get_modpath("cdmod") .. mode .. "_dirs/create_round_platform.lua")
...
dofile(minetest.get_modpath("cdmod") .. mode .. "_dirs/chat_create_circle.lua")
dofile(minetest.get_modpath("cdmod") .. mode .. "_dirs/get_value.lua")
dofile(minetest.get_modpath("cdmod") .. mode .. "_dirs/platform_entity.lua")
dofile(minetest.get_modpath("cdmod") .. mode .. "_dirs/create_relative_platform.lua")